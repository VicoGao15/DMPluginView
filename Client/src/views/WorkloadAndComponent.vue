...
<template>
	<div>
		<a-row type="flex" :gutter="24">
			...
			<a-col :span="24" :md="18" class="mb-24">
				<CardJobCategory></CardJobCategory>
			</a-col>
			<!-- Billing Information Column -->
		</a-row>
...
<script>
	...
	import CardJobCategory from "../components/Cards/NewCategory/CardJobCategory.vue"
	import CardComponentCategory from "../components/Cards/NewCategory/CardComponentCategory.vue"
